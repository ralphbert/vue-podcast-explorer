...
import { dummyUsers } from "@/mock/dummy-users";
...
export const dummyPosts = [
  ...
  const image = `https://picsum.photos/seed/${post.id}`;

  return {
    ...post,
    image: `${image}/1024/600`,
    previewImage: `${image}/256/256`,
    body: text.substr(0, Math.max(Math.random() * text.length, 250)),
    user: dummyUsers.find((u) => u.id === post.userId),
  } as Post;
});
